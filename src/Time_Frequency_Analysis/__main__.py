...
#execute the __main__.py module in order to test (and compare with the library) the transform's  -> 1)execution time 2)perfect reconstruction property 3)visualization   
...
#For NSGT_scale :   python __main__.py --front_end NSGT_SCALE_FRAMES -p "{ onset_det : False , ksi_s : 44100 , min_scl : 128 , ovrlp_fact : 0.5 , middle_window : np.hanning , matrix_form : 0 , multiproc : 1 }" --plot_spectrograms True
